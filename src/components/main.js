        ...
        return (
            <div className="markdown">
                ...
                <p className="capital" id="addressInput">
                    The Registry stores information you submit about an Ethereum
                    address on the blockchain and IPFS to make it{" "}
                    <b>openly accessible to users, wallets and apps</b> without
                    having to go through third parties that lock your data
                ...
                <p>
                    ...
                    <a href="https://theregistry.online/edit/0x6090a6e47849629b7245dfa1ca21d94cd15878ef">
                        Ethereum Name Service
                    </a>
                    ,{" "}
                    <a href="https://theregistry.online/edit/0x42d6622dece394b54999fbd73d108123806f6a18">
                        Spankchain
                    </a>
                    ,{" "}
                    <a href="https://theregistry.online/edit/0x267be1c1d684f78cb4f6a176c4911b741e4ffdc0">
                        Kraken
                    </a>
                </p>
                <p>
                ...
                <p>
                    ...
                    <code>.getByAddress(address)</code> on the contract. If
                    metadata is available, JSON can be retrieved by looking up
                    the IPFS address. This function returns the following tuple:{" "}
                    <br />
                    <code style={{ fontSize: 10 }}>
                        (<span style={{ color: "orange" }}>address</span>{" "}
                        address, <span style={{ color: "orange" }}>string</span>{" "}
                        name, <span style={{ color: "orange" }}>string</span>{" "}
                        ipfsHash, <span style={{ color: "orange" }}>bool</span>{" "}
                        isSelfAttested,{" "}
                ...
                <p>
                    ...
                    The current iteration of this contract prioritizes
                    self-attested data (submitted by the address itself) over
                    data submitted by other addresses. This website is a sample
                    implementation for interfacing with the contract.
                </p>
