        ...
        <label htmlFor={"flat-button-file" + this.state.key}>
          <InputBase
            ...
            className={
              ...
              " " +
              ("inputH4 dropzone" + (this.props.file ? " empty" : ""))
            }
            startAdornment={
              this.props.label ? (
                <React.Fragment>
                  ...
                  <InputAdornment
                    position="start"
                    className={
                      "dropzonecontent" + (this.props.file ? "" : " empty")
                    }
                  >
                    {this.props.file !== undefined ? (
                      this.props.file.name !== undefined ? (
                        ...
                        <div
                          ...
                          onClick={() => {
                            window.open(
                              "https://gateway.ipfs.io/ipfs/" + this.props.file,
                            );
                          }}
                        >
                          {this.props.file}
                      ...
                      <span className="dropzonetext">{"Click to upload"}</span>
                    )}
                  </InputAdornment>
                </React.Fragment>
              ) : (
      ...
      <InputBase
        ...
        className={
          ...
          (this.props.multiline
            ? "multilineHover"
            : "inputH4" + (!this.props.disabled ? " borderHover" : ""))
        }
        endAdornment={
