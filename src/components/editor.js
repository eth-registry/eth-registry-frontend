...
class Editor extends React.Component {
    ...
    canSubmit(contractdata) {
        ...
        if (!contractdata)
            return { allowed: false, reason: "Nothing to submit" };
    ...
    implementsTokenInterface() {
        return (
            (this.state.isContract &&
                this.state.knownInterfaces.indexOf(20) > -1) ||
                    ...
                    <FormGroup row>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    disabled={
                                        !this.canEdit(this.state.contractdata)
                                            .allowed
                                    }
                ...
                <div className="button-aligner">
                    ...
                    >
                        <span>
                            <Button
                                disabled={
                                    !this.canSubmit(this.state.contractdata)
                                        .allowed
                                }
                                size="small"
                                variant="contained"
